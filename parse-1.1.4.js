...
(function(root) {
  ...
  Parse._getInstallationId = function() {
    ...
    Parse._installationId = Ti.App.Properties.getString(path);//Ti localStorage Fix
    ...
    if (!Parse._installationId || Parse._installationId === "") {
      ...
      Ti.App.Properties.setString(path, Parse._installationId);//Ti localStorage Fix
  ...
  Parse._ajax = function(method, url, data, success, error) {
    ...
    //var xhr = new XMLHttpRequest();//Ti ajax fix
...
(function(root) {
  ...
  Parse.User = Parse.Object.extend("_User", /** @lends Parse.User.prototype */ {
    ...
    logOut: function() {
      ...
      Ti.App.Properties.removeProperty(Parse._getParsePath(Parse.User._CURRENT_USER_KEY));//Ti localStorage Fix
      //localStorage.removeItem(Parse._getParsePath(Parse.User._CURRENT_USER_KEY));
    },
    ...
    current: function() {
      ...
      var userData = Ti.App.Properties.getString(Parse.User._CURRENT_USER_KEY);
      //var userData = localStorage.getItem(Parse._getParsePath(Parse.User._CURRENT_USER_KEY));
      if (!userData) {
    ...
    _saveCurrentUser: function(user) {
      ...
      //localStorage.setItem(Parse._getParsePath(Parse.User._CURRENT_USER_KEY), JSON.stringify(json));
    },
